...
<body>
  <div id="overlay" class="overlay" aria-hidden="true" aria-modal="true" role="dialog">
    <div class="congratsBox">
      ...
      <a href="https://m.me/921757524343785" class="msgBtn"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M22 2L2 12l7.5 2.5L12 22l3.5-7.5L22 2z"/></svg> Message Me for comfirmation</a>
    </div>
  </div>
